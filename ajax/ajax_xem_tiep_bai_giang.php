<?php 
	...
	$idsv = $_POST['idsv'];
	$kh = $_POST['kh'];
	$query = "SELECT DISTINCT bg.IDBG, bg.TENBAI,bg.TOMTAT,bg.NOIDUNG,bg.NGAYDANG,bg.IDKH,bg.IDVIDEO FROM sv_dk_khoahoc sdk, baigiang bg, khoahoc kh WHERE sdk.IDSV = '$idsv' AND sdk.IDKH = '$kh' AND bg.IDKH = sdk.IDKH AND kh.IDKH = sdk.IDKH AND kh.TRANGTHAI = b'0' AND bg.IDBG = '$idbg'  AND bg.BATTAT=b'0' limit 0,1";
