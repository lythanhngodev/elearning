<?php 
	...
	$conn = $ketnoi->ketnoi();
	$query = "SELECT DISTINCT sd.IDSVKH, sv.HOSV, sv.TENSV, sv.MAIL, kh.TENKH, XACNHAN FROM khoahoc kh, sinhvien sv, sv_dk_khoahoc sd WHERE sd.IDSV = sv.IDSV AND sd.IDKH = kh.IDKH";
