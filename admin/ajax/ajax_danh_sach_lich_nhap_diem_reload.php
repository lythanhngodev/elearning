<?php 
	...
	$conn = $ketnoi->ketnoi();
	$query = "SELECT nd.IDND,nd.IDKH,nd.NGAYBDN,nd.NGAYKTN,kh.MAKH,kh.TENKH FROM nhapdiem nd, khoahoc kh WHERE nd.IDKH = kh.IDKH AND kh.TRANGTHAI = b'0' ORDER BY NGAYKTN DESC";
