<?php 
  ...
  $id = $_POST['id'];
	...
	$conn = $ketnoi->ketnoi();
	$query = "SELECT bg.IDBG, bg.IDGV, bg.TENBAI,bg.TOMTAT,bg.NOIDUNG, bg.NGAYDANG,bg.IDKH, bg.BATTAT,kh.TENKH,bg.IDVIDEO FROM baigiang bg, khoahoc kh WHERE bg.IDGV = '$id' AND bg.IDKH = kh.IDKH and kh.IDKH = '$kh'";
