<?php
	...
	$hoi_user = "SELECT gv.IDGV FROM login_gv lg, giaovien gv WHERE lg.IDGV = gv.IDGV AND gv.TrangThai = b'0' AND (BINARY `TenDangNhap` = '".$_SESSION['username']."') AND `MatKhau` = '".$_SESSION['password']."'";
