...
<!-- Content Header (Page header) -->
    <section class="content-header">
      <h1>
        Thống kê sinh viên không đạt theo khóa học
      </h1>
      <label> - Thông tin sinh viên không theo từng khóa học.<br> - Sinh viên đăng ký khóa học và được xác nhận thì mới có trong danh sách này!</label>
    </section>
    <!-- Main content -->
...
<script type="text/javascript" charset="utf-8">
  $(document).ready(function() {
    $("#xem-ds-sv-hk").click(function(){
      $.ajax({
        url : "ajax/ajax_du_lieu_sinh_vien_khong_dat_hoc_hoc_ky.php",
        type : "post",
        dataType:"text",
        data : {
          kh: $("#ma-khoa-hoc").val()
