              ...
              while ($row = mysqli_fetch_assoc($dulieu)) {
                ?>
                  <tr>
                    ...
                    <input type="hidden" name="" id="id-noi-dung-tb-<?php echo $row['IDLT']; ?>" value="<?php echo $row['NOIDUNG'] ?>">
                </tr>
                <?php
                $stt++;
              }
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="" id="tom-tat-thong-bao-them" placeholder="tóm tắt thông báo" required autocomplete="on">
          </div>
          <div class="form-group">
  ...
  <div class="modal-dialog modal-lg" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            <label>Tóm tắt thông báo</label>
            <input type="text" class="form-control" name="" id="tom-tat-thong-bao-sua" placeholder="tóm tắt thông báo" required autocomplete="on">
          </div>
          <div class="form-group">
            <label>Nội dung thông báo</label>
